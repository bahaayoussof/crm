...
/**
 * The Quick Reply "Reply text" field: the shared reply-style Lexical editor
 * (`RichTextEditor`), wired into react-hook-form through a
 ...
 * content (Edit) is the caller's job via the forwarded `RichTextEditorHandle`
