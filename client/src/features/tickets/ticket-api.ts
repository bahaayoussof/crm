...
import type { AgentOption, TicketCategory, TicketConversationItem, TicketConversationValues, TicketCreateValues, TicketDetail, TicketFilters, TicketListItem, TicketListResponse, TicketUpdateValues } from "./ticket.types";
...
export async function createTicketMessage(id: string, values: TicketConversationValues) { return (await apiClient.post<{ data: TicketConversationItem }>(`/tickets/${id}/messages`, values)).data.data; }
