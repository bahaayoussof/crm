  ...
  return (
    <TicketPage>
      ...
      <form className="mt-6 max-w-3xl overflow-visible rounded-md border bg-white" onSubmit={submit} noValidate>
        {apiError && (
          <p className="mx-5 mt-5 rounded-md border border-red-200 bg-red-50 p-3 text-sm text-red-700 sm:mx-6" role="alert">
            {apiError}
          </p>
        )}
        <section className="px-5 py-6 sm:px-6" aria-labelledby="ticket-details-heading">
          ...
          <div className="mt-5 space-y-5">
            {editing ? (
              <div>
                <span className="block text-sm font-medium">{t("tickets.customer")}</span>
                <p className="mt-2 rounded-md bg-muted px-3 py-2">
        ...
        <div className="flex flex-wrap justify-end gap-3 border-t bg-muted/35 px-5 py-4 sm:px-6">
