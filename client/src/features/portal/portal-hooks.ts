...
import type { PortalFilters } from "./portal.types";
export const portalKeys = { all: ["portal"] as const, overview: ["portal", "overview"] as const, categories: ["portal", "categories"] as const, tickets: (filters?: PortalFilters) => ["portal", "tickets", ...(filters ? [filters] : [])] as const, ticket: (id: string) => ["portal", "tickets", id] as const };
